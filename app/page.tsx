import Link from "next/link"; import {Header,Footer,Arrow} from "./components";
...
export default function Home(){return <><Header/><main className="home-visual-refresh">
  ...
  <section className="section wrap home-product-overview"><div className="section-heading"><div><h2 className="kicker">CORE PRODUCT</h2></div></div><div className="product-feature"><div className="feature-image"><img src="/images/products/amazon-current/st100-main-current.jpg" alt="SHOCKIS ST100 shockwave therapy system with handpiece, cable and seven applicator heads"/><span>PRODUCT SYSTEM / 01</span></div><div className="feature-copy"><p className="kicker">SHOCKWAVE THERAPY SYSTEM</p><h3>Clear operation.<br/>Consistent output.</h3><ul><li><span>01</span><div><b>Dual operation</b></div></li><li><span>02</span><div><b>Ergonomic handpiece</b></div></li><li><span>03</span><div><b>Seven applicator heads</b></div></li></ul><Link className="text-btn product-detail-link" href="/products/shockwave-therapy-system">View Product Details <Arrow/></Link></div></div></section>
  <section className="home-accessories"><div className="wrap"><div className="home-accessories-heading"><h2 className="kicker">ACCESSORIES</h2></div><div className="home-accessories-grid">{accessories.map(([name,image,alt])=><Link href="/products/accessories" className="home-accessory-item" key={name}><span><img src={image} alt={alt}/></span><b>{name}</b></Link>)}</div><div className="home-accessories-cta"><Link className="text-btn" href="/products/accessories">View All Accessories <Arrow/></Link></div></div></section>
  {false && <>
    <section className="section wrap"><div className="section-heading"><div><p className="kicker">QUALITY & MANUFACTURING</p><h2>From design intent<br/>to released product.</h2></div><div><p>Documented controls connect product requirements, supplier quality, assembly, inspection and final release.</p><Link className="text-btn" href="/quality-regulatory">Explore quality assurance <Arrow/></Link></div></div><div className="process"><div><span>01</span><b>Design control</b></div><div><span>02</span><b>Supplier quality</b></div><div><span>03</span><b>Controlled assembly</b></div><div><span>04</span><b>Inspection & release</b></div></div></section>
