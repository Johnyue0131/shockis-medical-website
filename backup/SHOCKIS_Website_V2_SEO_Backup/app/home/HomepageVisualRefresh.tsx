  ...
  return (
    <style>{`
      ...
      .home-visual-refresh .hero-background {
        background-image:
          linear-gradient(90deg, rgba(6, 31, 61, 1) 0%, rgba(6, 31, 61, 0.98) 34%, rgba(6, 31, 61, 0.84) 49%, rgba(6, 31, 61, 0.38) 72%, rgba(6, 31, 61, 0.56) 100%),
          url('/images/products/amazon-current/st100-provider-use.jpg') !important;
